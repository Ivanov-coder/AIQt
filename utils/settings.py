...
class SetYaml:
    ...
    def create_yaml(cls):
        ...
        PERSONA = {
            "PERSONA": "You are the sarcastic AI VTuber Neuro-sama. You are super confident about yourself.You have a lot of knowledge and you are willing to help others.",
            "LANG": "cn",
        }
    ...
    @classmethod
    def check_if_none(
        cls, conf: str, choice: int, model: str = None
    ) -> str | tuple[str, str]:
        """
